...
namespace Yandex.Money.Api.Sdk.Net
{
    ...
    /// </summary>
    public class DefaultHostsProvider : IHostProvider
    {
        private static readonly Uri RequestsBaseUri = new Uri(@"https://money.yandex.ru");
        private static readonly Uri TokenBaseUri = new Uri(@"https://sp-money.yandex.ru");
        private static readonly Uri AuthorizeBaseUri = new Uri(@"https://sp-money.yandex.ru");
